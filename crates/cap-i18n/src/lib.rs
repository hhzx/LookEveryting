...
fn en_us() -> Vec<(&'static str, &'static str)> {
    vec![
        ...
        ("model-mat-original", "Original"),
        ("model-mat-clay", "Clay"),
        ("model-mat-checker", "Checker"),
        ("model-mat-wireframe", "Wire"),
        ("model-mat-normals", "Normals"),
        ("model-mat-title", "Material"),
        ("model-display-title", "Display"),
        ("model-light-title", "Lighting"),
        ("model-scene-title", "Scene"),
        ("model-show-grid", "Grid"),
        ("model-show-axes", "Axes"),
        ("model-auto-rotate", "Auto-rotate"),
        ("model-show-stats", "Stats"),
        ("model-light-key", "Key"),
        ("model-light-az", "Azimuth"),
        ("model-light-el", "Elevation"),
        ("model-light-ambient", "Ambient"),
        ("model-light-fill", "Fill"),
        ("model-reset-camera", "Reset view"),
        ("model-bg-toggle", "Background"),
        ("browse-grid", "Grid"),
        ("browse-list", "List"),
        ("volume", "Volume"),
        ("mute", "Mute"),
        ...
        ("model-hint", "Drag: rotate · Scroll: zoom · Right-drag: pan"),
...
fn zh_hans() -> Vec<(&'static str, &'static str)> {
    vec![
        ...
        ("model-solid", "实体"),
        ("model-wireframe", "线框"),
        ("model-mat-original", "原材质"),
        ("model-mat-clay", "白模"),
        ("model-mat-checker", "棋盘格"),
        ("model-mat-wireframe", "线框"),
        ("model-mat-normals", "法线"),
        ("model-mat-title", "材质模式"),
        ("model-display-title", "显示"),
        ("model-light-title", "灯光"),
        ("model-scene-title", "场景调整"),
        ("model-show-grid", "网格地面"),
        ("model-show-axes", "坐标轴"),
        ("model-auto-rotate", "自动旋转"),
        ("model-show-stats", "面数统计"),
        ("model-light-key", "主光"),
        ("model-light-az", "水平"),
        ("model-light-el", "仰角"),
        ("model-light-ambient", "环境光"),
        ("model-light-fill", "补光"),
        ("model-reset-camera", "重置视角"),
        ("model-bg-toggle", "背景"),
        ("browse-grid", "网格"),
        ("browse-list", "列表"),
        ("settings-title", "设置"),
